...
namespace GarderieManagementClean.Infrastructure.Migrations
{
    ...
    [Migration("20220724071119_RemovedLocalEntityAndAddedPhotoEntity")]
    partial class RemovedLocalEntityAndAddedPhotoEntity
    {
            ...
            modelBuilder.Entity("GarderieManagementClean.Domain.Entities.Photo", b =>
                {
                    ...
                    b.HasIndex("EnfantId")
                        .IsUnique()
                        .HasFilter("[EnfantId] IS NOT NULL");

                    b.HasIndex("EnfantId1");
